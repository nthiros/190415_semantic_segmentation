...
def unet(input_shape, initial_exp=6):
    ...
    last_conv = Conv2D(filters=1, kernel_size=1, padding='same', activation='sigmoid')(c13)
...
if __name__ == '__main__':
    ...
    model.fit_generator(train_generator,
            steps_per_epoch=(3041-305)//batch_size,epochs=200,validation_data=test_generator,validation_steps=301//8,callbacks=[checkpoint,lr_scheduler,
                tb])
